    ...
    return (
        ...
        <div className="w-full min-h-screen justify-center items-center flex flex-col max-[330px]:mb-6 overflow-hidden">
            ...
            <div className="flex flex-col w-full items-center gap-3">
                ...
                <Link to="/home">
                    <button
                        class="cursor-pointer p-[4px] rounded-[12px] bg-gradient-to-b from-white to-stone-200/40 shadow-[0_1px_3px_rgba(0,0,0,0.5)] active:shadow-[0_0px_1px_rgba(0,0,0,0.5)] active:scale-[0.995]"
                    >
                        <div
