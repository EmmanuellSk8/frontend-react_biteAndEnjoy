export default function CardDish({name, ingredients, img, entradas}) {
    ...
    return (
        <>
            <article className="cursor-pointer shadow-xl flex flex-col justify-between items-center py-8 px-8 bg-white/80 rounded-xl border-1 border-gray-200 h-[500px] relative">
                ...
                <div className="flex flex-col gap-4 w-full px-8 top-86 absolute justify-between">
                    ...
                    <h3 className='text-sm font-semibold text-zinc-600 border-1 border-gray-600 px-3 rounded-xl'>{entradas}</h3>
                    </div>
