...
export default function Hero() {
    ...
    return (
        <>
            <section id='Hero' className="w-[full] flex flex-wrap h-dvh">
                <div className="absolute w-full h-full bgHero"></div>
                <div className="max-w-[1600px] flex flex-wrap justify-between items-center content-center">
