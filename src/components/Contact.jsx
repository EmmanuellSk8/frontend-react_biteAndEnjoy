...
<>
    ...
    <div>
        ...
        <div class="grid grid-cols-1 gap-12 mt-10 md:grid-cols-2 lg:grid-cols-3">
            <div class="flex flex-col shadow-2xl cursor-pointer items-center justify-center text-center py-15 hover:bg-blue-200 rounded-lg duration-200 ease-in-out">
            ...
            <div class="flex flex-col shadow-2xl  py-15 cursor-pointer items-center justify-center text-center hover:bg-blue-200 rounded-lg duration-200 ease-in-out">
                <span class="p-3 text-orange-500 rounded-full bg-orange-100/80 dark:bg-gray-800">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
